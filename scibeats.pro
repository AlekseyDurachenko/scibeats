...
# current project (.pri)
include($$PWD/scibeats-sources.pri)
include($$PWD/scibeats-tests.pri)
include($$PWD/scibeats-unixinstall.pri)
include($$PWD/scibeats-unixrules.pri)
include($$PWD/scibeats-win32install.pri)
include($$PWD/scibeats-win32rules.pri)


# the 3rd libraries (.pri)
include($$PWD/submodules/qtsampleengine/qtsampleengine.pri)
